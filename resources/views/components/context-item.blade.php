<a {{ $attributes->merge(['class' => 'group flex items-end gap-x-3 hover:bg-gray-300 hover:dark:bg-gray-500 text-gray-600 dark:text-gray-300 w-full px-4 py-3 font-semibold cursor-pointer smooth-300']) }}>
    @isset($icon)
