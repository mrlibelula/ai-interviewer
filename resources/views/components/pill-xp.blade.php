@props(['label' => '', 'bold_text' => 'total xp'])
@php
    $bold_text = 'total xp';
@endphp
<div {{ $attributes->merge(['class' => 'flex items-center gap-x-3 text-base justify-between bg-white dark:bg-black/50 px-3 py-3 rounded-md w-full hover:bg-gray-100/60 hover:dark:bg-black smooth-300 group']) }}>
