...
>
    ...
    <div class="relative">
        ...
        <textarea 
            ...
            @keydown.enter.prevent="loader74 = true; error = false; $dispatch('sendMessage', { chat_message }); chat_message = '';" 
            id="chat-textarea" 
        ...
        ></textarea>
        <div 
            @click.prevent="loader74 = true; error = false; $dispatch('sendMessage', { chat_message }); chat_message = '';" 
